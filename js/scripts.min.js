...
var timeLineIcons = [ '<i class="fa fa-suitcase" aria-hidden="true"></i>',  '<i class="fa fa-search" aria-hidden="true"></i>','<i class="fa fa-graduation-cap" aria-hidden="true"></i>', '<i class="fa fa-comments" aria-hidden="true"></i>', '<i class="fa fa-globe" aria-hidden="true"></i>', '<i class="fa fa-users" aria-hidden="true"></i>'];
    ...
    n('#experience-timeline').each(function() {
      ($this = n(this)),
        ...
        $this.find('.vtimeline-point').each(function(index, element) {
          n(this).prepend(
            '<div class="vtimeline-icon">' + timeLineIcons[index] + '</div>',
          );
        }),
